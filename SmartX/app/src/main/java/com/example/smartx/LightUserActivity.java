...
public class LightUserActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.light_button).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.logout_button) {
            ...
            startActivity(new Intent(this, LightGuideActivity.class));
        } else if (id == R.id.settings_icon) {
            startActivity(new Intent(this, LightSettingsActivity.class));
        } else if (id == R.id.homepage_button) {
            startActivity(new Intent(this, LightHomePage.class));
        } else if (id == R.id.light_button) {
            startActivity(new Intent(this, LightPage.class));
        }
    }
    ...
    private void logout() {
        Intent intent = new Intent(LightUserActivity.this, MainActivity.class);
