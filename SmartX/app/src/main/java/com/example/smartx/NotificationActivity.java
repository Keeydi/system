...
public class NotificationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        infoIcon.setOnClickListener(v -> startActivity(new Intent(NotificationActivity.this, GuideActivity.class)));

        ImageView settingsIcon = findViewById(R.id.settings_icon);
        settingsIcon.setOnClickListener(v -> startActivity(new Intent(NotificationActivity.this, SettingsActivity.class)));
    }
}
