...
public class LightConsumptionYearActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_light_consumption_year);
    ...
    private void showTimeframeDialog(View v) {
        ...
        monthOption.setOnClickListener(view1 -> {
            startActivity(new Intent(this, LightConsumptionMonthActivity.class));
            finish();
            dialog.dismiss();
        });
