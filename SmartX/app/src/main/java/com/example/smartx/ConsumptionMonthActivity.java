...
public class ConsumptionMonthActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consumption_month);
    ...
    private void loadMonthlyData(String monthKey) {
        ...
        pzemRef.child("history").child(monthKey).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                dataSet.setColor(ContextCompat.getColor(ConsumptionMonthActivity.this, R.color.orange));
    ...
    private void showTimeframeDialog(View v) {
        ...
        yearOption.setOnClickListener(view1 -> {
            startActivity(new Intent(this, ConsumptionYearActivity.class));
            finish();
            dialog.dismiss();
        });
